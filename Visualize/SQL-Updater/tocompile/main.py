...
class MainLayout(BoxLayout):
    ...
    def add_event(self, event):
        ...
        global LANGUAGE_TO_DEL, CATEGORY_TO_DEL, CONTENT_TO_DEL
        ...
        if 'del' in CURRENT_EVENT:
            ...
            database_manager.update_database(CURRENT_EVENT, CURRENT_PATH[0], CURRENT_PATH[1], data)
            self.refresh()

    def update_database(self):
        global CURRENT_EVENT, CURRENT_DATA, CURRENT_PATH
        global LANGUAGE_TO_ADD, CATEGORY_TO_ADD, CONTENT_TO_ADD
        ...
        if len(self.ids.text_input.text)>0:
            ...
            self.ids.text_input.text = ''
            database_manager.update_database(CURRENT_EVENT, CURRENT_PATH[0], CURRENT_PATH[1], txt)
            self.refresh()
